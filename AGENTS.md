...
- Keep this app Windows-first. The floating balance widget, tray behavior, NSIS installer, and release workflow are scoped to Windows.
...
- `pnpm build` validates TypeScript and frontend build.
- `pnpm check:desktop` validates Rust and Tauri config compilation.
